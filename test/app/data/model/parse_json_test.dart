...
void main() {
  ...
  group('test parsing json', () {
    ...
    test(
      "test restaurant parsing from string",
      () {
        final _result = RestaurantModel.fromJson(_restaurantString);
        expect(_result.id, _restaurantId);
      },
    );
    test(
      "test restaurant parsing from Map",
      () {
        final _result = RestaurantModel.fromMap(_restaurantMap);
        expect(_result.id, _restaurantId);
      },
    );
  });
